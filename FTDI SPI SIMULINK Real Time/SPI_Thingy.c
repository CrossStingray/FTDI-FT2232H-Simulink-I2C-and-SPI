 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Jun 09 11:29:14 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                SPI_Thingy
...
extern void SPI_Thingy_Start_wrapper(void);
extern void SPI_Thingy_Outputs_wrapper(real_T *y0,
  real_T *y1,
  real_T *y2,
  real_T *y3,
  real_T *y4,
  real_T *y5);
extern void SPI_Thingy_Terminate_wrapper(void);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  SPI_Thingy_Outputs_wrapper(y0, y1, y2, y3, y4, y5);
}
